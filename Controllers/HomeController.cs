...
namespace Banco.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Consigna(ConsignaViewModel modelo)
        {
            ...
            // Actualizar el saldo de la cuenta del destinatario
        ...
        public async Task<IActionResult> ConsultarMovimientos()
        {
            ...
            // Obtener los movimientos del usuario que sean de tipo "Retirar" o "Consignar"
            var movimientos = await _dbContext.Movimientos
                .Include(m => m.TipoMovimiento)
                .Where(m => m.IdUsuario == idUsuario && (m.TipoMovimiento.Nombre == "Retirar" || m.TipoMovimiento.Nombre == "Consignar"))
                .ToListAsync();
